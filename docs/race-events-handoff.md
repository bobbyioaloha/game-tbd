...
- The main race offers at most two stars, one fresh attempt per star. After activation, expiry, failure, or a missed star, wait four gameplay seconds, then offer the next star 120 m ahead if enough race remains. A collectible still waiting for other racers blocks the next star.
...
- Capture/transcription/generation keep separate 8/10/30-second budgets. Admission also reserves the reveal buffer and approach/effect time and the star's speaking window. Recheck at recording and submission; boosts can still make final placement too late. No automatic retries or encores.
