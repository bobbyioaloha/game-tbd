...
pinball: static copies become bumpers in staggered lanes or a narrowing funnel. Springy contact launches outward; ricochet redirects the incoming trajectory. Racers can aim their approach to chain useful bounces.
buddy: pair racers with the nearest available racer or across the field. An elastic tether pulls the pair together only when stretched; pulsing tension tightens and relaxes visibly. No solo target or owner exemption.
orbit: local fields pull and swirl racers clockwise or counterclockwise around the object. Gentle or clingy pull controls escape difficulty. Racers steer outward to exit with sideways momentum; this never teleports or locks controls.
reconstruction: copies replay sampled recent flight paths farther down the course after a visible warning. Trail preserves the path; mirror reflects it across the lane. Steady emits spaced copies; bursts emits batches. Copies become dodgeable hazards, not racers or arbitrary stored history.
observation: generated inspectors cast visible sweeping or alternating cones. Sideways movement inside a cone after a grace period earns a shove. Patient gives longer grace; strict gives shorter grace. Straight descent remains allowed.
Use requested behavior first: charging/scattering/convoys map to stampede; flowing/sliding/routes to rapids; bouncing to pinball; pairing/tethering to buddy; attraction/swirl/slingshots to orbit; replaying/mirroring paths to reconstruction; inspecting/watching movement to observation. The object's noun or clothing never restricts its family.
...
For example, a friendly guide can lead a drafting convoy; a timid character can scatter; an angry pursuer can charge. Slick/gliding objects or rainwear can suggest currents, with rhythmic movement suggesting pulses. Rubber or springy material suggests pinball; clingy support or joining equipment suggests buddy; an attention-seeking celestial object suggests orbit; haunted copying equipment suggests reconstruction; suspicious or authoritarian characters suggest observation. A friendly inspector can be patient; a demanding one strict. A description can inform variant choices as well as the family.
