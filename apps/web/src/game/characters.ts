export const CHARACTERS = [
  ...
  {id:'susan', introPose:'Equipment check', personality:'Practical caretaker. Ready before everyone else.', model:'susan', name:'Susan', species:'Parasaurolophus', department:'Facilities', color:'#bca454', note:'Equipment checked. Waiting on everyone else.', ready:true},
] as const;
